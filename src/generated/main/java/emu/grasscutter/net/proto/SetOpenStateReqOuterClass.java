...
public final class SetOpenStateReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.proto.SetOpenStateReqOuterClass.internal_static_SetOpenStateReq_fieldAccessorTable
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq)) {
    ...
    public static emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq parseFrom(
    ...
    public static emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq parseFrom(
    ...
    public static emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq prototype) {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq getDefaultInstanceForType() {
        return emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq build() {
        emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq) {
          return mergeFrom((emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq)other);
        } else {
    ...
    private static final emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq();
    }

    public static emu.grasscutter.net.proto.SetOpenStateReqOuterClass.SetOpenStateReq getDefaultInstance() {
