...
public final class FurnitureMakeSlotOuterClass {
  ...
  public interface FurnitureMakeSlotOrBuilder extends
    ...
    emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeDataOrBuilder getFurnitureMakeDataListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 82: {
              ...
              furnitureMakeDataList_.add(
                  input.readMessage(emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.internal_static_FurnitureMakeSlot_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.internal_static_FurnitureMakeSlot_fieldAccessorTable
    ...
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData> getFurnitureMakeDataListList() {
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData getFurnitureMakeDataList(int index) {
      return furnitureMakeDataList_.get(index);
    }

    @java.lang.Override
    public emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeDataOrBuilder getFurnitureMakeDataListOrBuilder(
        int index) {
      return furnitureMakeDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot other = (emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot) obj;
    ...
    public static emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseFrom(
    ...
    public static emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseFrom(
    ...
    public static emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlotOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.internal_static_FurnitureMakeSlot_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot getDefaultInstanceForType() {
        return emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot build() {
        emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot buildPartial() {
        emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot result = new emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot) {
          return mergeFrom((emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot other) {
        if (other == emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot.getDefaultInstance()) return this;
        if (furnitureMakeDataListBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot) e.getUnfinishedMessage();
      ...
      private void ensureFurnitureMakeDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          furnitureMakeDataList_ = new java.util.ArrayList<emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData>(furnitureMakeDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData, emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData.Builder, emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeDataOrBuilder> furnitureMakeDataListBuilder_;
      ...
      public Builder setFurnitureMakeDataList(
          int index, emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData value) {
        if (furnitureMakeDataListBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setFurnitureMakeDataList(
          int index, emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData.Builder builderForValue) {
        if (furnitureMakeDataListBuilder_ == null) {
          ensureFurnitureMakeDataListIsMutable();
      ...
      public Builder addFurnitureMakeDataList(emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData value) {
        if (furnitureMakeDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addFurnitureMakeDataList(
          emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData.Builder builderForValue) {
        if (furnitureMakeDataListBuilder_ == null) {
          ensureFurnitureMakeDataListIsMutable();
      ...
      public Builder addAllFurnitureMakeDataList(
          java.lang.Iterable<? extends emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData> values) {
        if (furnitureMakeDataListBuilder_ == null) {
          ensureFurnitureMakeDataListIsMutable();
      ...
      public emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData.Builder getFurnitureMakeDataListBuilder(
          int index) {
      ...
      public emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData.Builder addFurnitureMakeDataListBuilder() {
        return getFurnitureMakeDataListFieldBuilder().addBuilder(
            emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData.getDefaultInstance());
      }

      public emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData.Builder addFurnitureMakeDataListBuilder(
          int index) {
        return getFurnitureMakeDataListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData.getDefaultInstance());
      }
    ...
    private static final emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot();
    }

    public static emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ture_make_data_list\030\r \003(\0132\022.FurnitureMak" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.getDescriptor(),
        });
    internal_static_FurnitureMakeSlot_descriptor =
