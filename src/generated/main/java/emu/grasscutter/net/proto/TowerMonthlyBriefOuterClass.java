...
public final class TowerMonthlyBriefOuterClass {
  ...
  public interface TowerMonthlyBriefOrBuilder extends
    ...
    /**
     * <code>uint32 EPPJPCMDGEK = 4;</code>
     * @return The ePPJPCMDGEK.
     */
    int getEPPJPCMDGEK();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int EPPJPCMDGEK_FIELD_NUMBER = 4;
    private int ePPJPCMDGEK_;
    /**
     * <code>uint32 EPPJPCMDGEK = 4;</code>
     * @return The ePPJPCMDGEK.
     */
    @java.lang.Override
    public int getEPPJPCMDGEK() {
      return ePPJPCMDGEK_;
    }
    ...
    public int getSerializedSize() {
      ...
      if (ePPJPCMDGEK_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, ePPJPCMDGEK_);
      }
      if (fFJJEFKCJEC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getEPPJPCMDGEK()
          != other.getEPPJPCMDGEK()) return false;
      if (getTowerScheduleId()
          != other.getTowerScheduleId()) return false;
      if (getFFJJEFKCJEC()
          != other.getFFJJEFKCJEC()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + EPPJPCMDGEK_FIELD_NUMBER;
      hash = (53 * hash) + getEPPJPCMDGEK();
      hash = (37 * hash) + TOWER_SCHEDULE_ID_FIELD_NUMBER;
      hash = (53 * hash) + getTowerScheduleId();
      hash = (37 * hash) + FFJJEFKCJEC_FIELD_NUMBER;
      hash = (53 * hash) + getFFJJEFKCJEC();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief buildPartial() {
        ...
        result.ePPJPCMDGEK_ = ePPJPCMDGEK_;
        result.towerScheduleId_ = towerScheduleId_;
        result.fFJJEFKCJEC_ = fFJJEFKCJEC_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief other) {
        ...
        if (other.getEPPJPCMDGEK() != 0) {
          setEPPJPCMDGEK(other.getEPPJPCMDGEK());
        }
        if (other.getTowerScheduleId() != 0) {
          setTowerScheduleId(other.getTowerScheduleId());
        }
        if (other.getFFJJEFKCJEC() != 0) {
          setFFJJEFKCJEC(other.getFFJJEFKCJEC());
        }
      ...
      /**
       * <code>uint32 EPPJPCMDGEK = 4;</code>
       * @param value The ePPJPCMDGEK to set.
      ...
      /**
       * <code>uint32 FFJJEFKCJEC = 12;</code>
       * @param value The fFJJEFKCJEC to set.
       * @return This builder for chaining.
       */
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\027TowerMonthlyBrief.proto\"X\n\021TowerMonthl" +
      "yBrief\022\023\n\013EPPJPCMDGEK\030\004 \001(\r\022\031\n\021tower_sch" +
      "edule_id\030\017 \001(\r\022\023\n\013FFJJEFKCJEC\030\014 \001(\rB\033\n\031e" +
    ...
    internal_static_TowerMonthlyBrief_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TowerMonthlyBrief_descriptor,
        new java.lang.String[] { "EPPJPCMDGEK", "TowerScheduleId", "FFJJEFKCJEC", });
  }
